 export const products = [
{
    ...
    price:1960,
    description:"The state of mind is lorem There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form",
    category:"Watches",
},
{
    id:2,
...
},
{
    ...
    name:"RB Black Glass",
    price:533,
    description:"RB Black Glass is lorem There are many variations of passages of Lorem Ipsum available, if you are going to use a passage of Lorem Ipsum.",
    category:"Glasses",
},
{
    id:5,
